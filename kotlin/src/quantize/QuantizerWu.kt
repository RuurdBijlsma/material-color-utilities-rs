...
//    println("QuantizerWu.kt - quantize - mapResult: $mapResult")
//    println("QuantizerWu.kt - quantize - mapResult.colorToCount.size: ${mapResult.colorToCount.size}")
...
//    println("QuantizerWu.kt - quantize - colors: $colors")
...
//    println("QuantizerWu.kt - createBoxes - volumeVariance.size: ${volumeVariance.size}")
...
//    println("QuantizerWu.kt - createResult - colorCount: $colorCount")
    val colors: MutableList<Int> = ArrayList()
    for (i in 0 until colorCount) {
      val cube = cubes[i]
      val weight = volume(cube, weights)
//      println("QuantizerWu.kt - createResult - cube: $cube, weight: $weight")
      if (weight > 0) {
  ...
  internal class Box {
    ...
    override fun toString(): String {
      return "Box(r0=$r0, r1=$r1, g0=$g0, g1=$g1, b0=$b0, b1=$b1, vol=$vol)"
    }
  }
