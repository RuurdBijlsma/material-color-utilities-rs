  ...
  override val onPrimaryContainer: DynamicColor
    get() =
      DynamicColor(
        ...
        palette = { scheme -> scheme.primaryPalette },
        tone = { scheme ->
//          println("ColorSpec2021.kt onPrimaryContainer tone getter -> called")
          if (isFidelity(scheme)) {
//            println("is fidelity")
...
//    println("ColorSpec2021.kt getHct: tone $tone")
...
//    println("ColorSpec2021.kt getTone: toneDeltaPair is null?: ${toneDeltaPair == null}")
...
//      println("ColorSpec2021.kt TDP is null - getTone: answer: $answer")
