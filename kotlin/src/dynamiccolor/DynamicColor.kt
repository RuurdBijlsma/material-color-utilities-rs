...
//    println("DynamicColor.kt getArgb: ${Hct.fromInt(argb)}")
...
//      println("DynamicColor.kt getHct: cachedAnswer $cachedAnswer")
      return cachedAnswer
    }
//    println("DynamicColor.kt getHct: scheme.specVersion ${scheme.specVersion}")
    val answer = ColorSpecs.get(scheme.specVersion).getHct(scheme, this)
//    println("DynamicColor.kt getHct: answer $answer")
...
//          println("hiiiiiiiiiiiiiii")
          background(scheme)?.getTone(scheme) ?: 50.0
      }
    }
  }
}
