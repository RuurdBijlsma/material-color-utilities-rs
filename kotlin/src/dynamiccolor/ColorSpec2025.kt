  ...
  override val primaryDim: DynamicColor
    get() {
      return DynamicColor(
        ...
        toneDeltaPair = {
          // Where does it get this primary dim? 
          val specPrimaryDim = primaryDim;
//          println("ColorSpec2025.kt primaryDim: specPrimaryDim $specPrimaryDim")
          val tdp = ToneDeltaPair(
            roleA = specPrimaryDim,
            roleB = primary,
            delta = 5.0,
            polarity = TonePolarity.DARKER,
            constraint = DeltaConstraint.FARTHER,
          )
//          println("ColorSpec2025.kt primaryDim: toneDeltaPair $tdp")
          tdp
        },
      )
    }
...
//    println("ColorSpec2025.kt hetHct: chromaMultiplier: $chromaMultiplier")
