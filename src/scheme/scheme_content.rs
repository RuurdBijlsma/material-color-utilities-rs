...
impl SchemeContent {
    ...
    pub fn new_with_list_and_platform_and_spec(
        ...
        let mut scheme = DynamicScheme::new_with_platform_and_spec(
            ...
            platform,
            spec_version,
            spec.get_primary_palette(Variant::Content, source_color_hct, is_dark, platform, contrast_level),
            spec.get_secondary_palette(Variant::Content, source_color_hct, is_dark, platform, contrast_level),
            spec.get_tertiary_palette(Variant::Content, source_color_hct, is_dark, platform, contrast_level),
            spec.get_neutral_palette(Variant::Content, source_color_hct, is_dark, platform, contrast_level),
            spec.get_neutral_variant_palette(Variant::Content, source_color_hct, is_dark, platform, contrast_level),
            spec.get_error_palette(Variant::Content, source_color_hct, is_dark, platform, contrast_level),
        );
